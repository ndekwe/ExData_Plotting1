...
print(" You can install it by running <<install.packages("sqldf")>>")
...
## Legend is still missig here, make sure you add it properly
legend("topright", legend = "Energy sub meyering")
dev.copy(png,file = "plot3.png")
dev.off()
print("Please get plot3.png under your working directory")
